...
function inquiry($array = array())
{
    ...
    {
        $query = "
        SELECT * FROM siswa_newdetailsmu 
        where siswa_jenis_bayar not in( SELECT siswa_jenis_bayar FROM siswa_newdetailsmu where SUBSTRING(siswa_flag , 1, 1)='y' )
        ...
        echo $tglterakhirbayar;
        echo $tmpstartdate->format('Ym');
        if($tglterakhirbayar==$tmpstartdate->format('Ym'))
        {
    ...
    (
        ...
        'billInfo6' =>  $intervalDate->format('m') . ' Bulan',
        'billInfo7' => '',
        'billInfo8' => '',
...
inquiry(array('billKey1'=>'12317000110170118'));
